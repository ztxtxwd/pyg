...
app.controller('goodsController' ,function($scope,$controller,$location,goodsService,uploadService,itemCatService,typeTemplateService){	
	...
	$scope.findOne=function(){
		 ...
		 * 但是这个时候angular要求的地址路由的写法为: http://localhost:9102/admin/goods_edit.html#?id=12321321&name=fadsa
		 */
		...
		goodsService.findOne(id).success(
			function(response){
				...
				//注意:通过id查询出来的也是一个组合实体类对象,整个entity是一个json对象,但是对于里面的属性比如图片列表,知识json格式的字符串
				//转换图片字段
