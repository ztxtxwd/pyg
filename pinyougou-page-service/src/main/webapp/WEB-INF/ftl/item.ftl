...
<#include "head.ftl">
<#--
图片列表数据来源是:tb_goods_desc表中的item_images字段,
值的格式为:[
...
<#--
扩展属性来自:tb_goods_desc表中的custom_attribute_items字段
数据格式为:[{"text":"内存大小","value":"10G"},{"text":"颜色","value":"红色"}]
-->
<#assign customAttributeList=goodsDesc.customAttributeItems?eval>
<#--
规格来自:tb_goods_desc表中的specification_items
数据格式为:[{"attributeValue":["移动3G","移动4G"],"attributeName":"网络"},{"attributeValue":["16G"],"attributeName":"机身内存"}]
-->
