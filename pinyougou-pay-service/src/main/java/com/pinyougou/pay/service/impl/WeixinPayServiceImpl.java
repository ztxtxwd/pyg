...
public class WeixinPayServiceImpl implements WeixinPayService {
	...
	/**
	 * out_trade_no:并非品优购系统的订单号,我们每次在提交支付时可能不只一个订单(购物车中有几个商家就有几个订单),
	 * 虽然订单可能不只一个但是我们只需支付一次,因此这里的out_trade_no表明的是我们品优够系统对这次支付行为的一个交易单号
	 */
	@Override
	public Map createNative(String out_trade_no, String total_fee) {
		...
		try {
			...
			/*WXPayUtil.isSignatureValid(xmlResult, partnerkey);
			WXPayUtil.isSignatureValid(mapResult, partnerkey);*/
