...
public class TbItem implements Serializable{
	...
	//将pojo中的属性跟solr中的域绑定到一起
	
	@Field     //默认域的名称和属性名称一致
    private Long id;  //而且id域还有点特殊,是属于每个文档的主键域
	
	@Field("item_title")   //如果域的名称和属性名称不对应可以在注解中指定,注意域的名称一定要和在solrHome中的schema.xml中配置的域名称保持一致
